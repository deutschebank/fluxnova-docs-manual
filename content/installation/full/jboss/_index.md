...
This document describes the installation of the [Full Distribution]({{< ref "/introduction/downloading-flowave.md#full-distribution" >}}) for [WildFly Application Server / JBoss EAP](http://www.wildfly.org).
