...
title: "Install Flowave Run"
weight: 05

menu:
  main:
    name: "Remote Engine Distribution"
    identifier: "installation-flowave-bpm-run"
    parent: "installation-guide"
    pre: "Install Flowave Run, an easy to configure remote engine distribution of Flowave. No Java knowledge necessary."
---
...
This page describes the steps to execute Flowave Run.
...
1. Configure the distro as described in the [User Guide]({{< ref "/user-guide/flowave-bpm-run.md" >}}).
1. Start Flowave Run by executing the start script (start.bat for Windows, start.sh for Linux/Mac).
1. Access the Flowave webapps (Cockpit, Tasklist, Admin) via http://localhost:8080/flowave/app/.
