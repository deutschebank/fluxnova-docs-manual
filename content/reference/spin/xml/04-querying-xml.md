...
String xml = "<root xmlns:t=\"http://fluxnova.finos.org\"><t:child id=\"child\"><a id=\"a\"/></t:child></root>";

SpinXmlTreeElement child = XML(xml).xPath("/root/t:child")
                                   .ns("t", "http://fluxnova.finos.org");
                                   .element();
```
...
namespaceMap.put("t", "http://fluxnova.finos.org");
namespaceMap.put("s", "http://fluxnova.finos.org");
...
{{< note class="info" >}}
  ...
  E.g.,: ```<root xmlns="http://fluxnova.finos.org"></root>``` -- prefix: DEFAULT, namespace: http://fluxnova.finos.org so you need
