...
title: 'Flowave Spin Dataformat Reference'
weight: 60
...
Flowave Spin is a library for simple XML and JSON processing on the JVM (Java
...
{{< note title="Flowave BOM" >}}
  If you use Spin in combination with the Flowave process engine,
  ...
  Flowave BOM</a> to ensure that you use the Flowave Spin version matching your process engine
  version.
{{< /note >}}
...
<dependencyManagement>
  <dependencies>
    <dependency>
      ...
      <artifactId>flowave-spin-bom</artifactId>
      <scope>import</scope>
      <type>pom</type>
...
<dependencies>
  ...
  <dependency>
    <groupId>org.finos.flowave.spin</groupId>
    <artifactId>flowave-spin-dataformat-all</artifactId>
  </dependency>
</dependencies>
```

Flowave Spin is published to [maven central](http://search.maven.org/#search%7Cga%7C1%7Cflowave-spin).
