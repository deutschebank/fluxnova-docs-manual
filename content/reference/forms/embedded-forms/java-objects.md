  ...
  camForm.on('form-loaded', function() {
    ...
    camForm.variableManager.createVariable({
      ...
      valueInfo: {
        ...
        objectTypeName: 'org.finos.flowave.bpm.example.CustomerData'
      }
    });
...
A full example of this feature can be found in the [Flowave Examples Repository](https://github.com/finos/flowave-bpm-examples/tree/master/usertask/task-form-embedded-serialized-java-object).
