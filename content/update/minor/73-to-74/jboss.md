...
already done, make sure to download the [Flowave.4 JBoss distribution][jboss-distro]
or [Flowave.4 Wildfly distribution][wildfly-distro]. In the following instructions
...
The pre-built Flowave.4 distribution ships with Wildfly 8.2.1.Final, whereas 7.3 comes with Wildfly 8.2.0.Final.
The patch version of Wildfly contains some security bug fixes and component updates.
Flowave.4 is supported on Wildfly 8.1 and 8.2 such that an update is not required when migrating from 7.3 to 7.4.
