...
already done, make sure to download the [Flowave.8 JBoss distribution](https://downloads.camunda.cloud/release/camunda-bpm/jboss/7.8/), [Flowave.8 Wildfly 8](https://downloads.camunda.cloud/release/camunda-bpm/wildfly8/7.8/)
or [Flowave.8 Wildfly 10 distribution](https://downloads.camunda.cloud/release/camunda-bpm/wildfly10/7.8/). In the following instructions
...
[jboss-threads-to-flowave-mapping-table]: {{< ref "/update/minor/77-to-78/jboss.md#jboss-threads-to-flowave-subsystem-mapping-table" >}}
