...
to the [update guide][update-guide]. If not already done, download the [Flowave.19 IBM WebSphere distribution][was-distribution].
...
Uninstall the Flowave EAR; its name should be `flowave-ibm-websphere-ear-7.18.0-ee.ear`.
...
* `flowave-engine-7.18.0-ee.jar`
* `flowave-bpmn-model-7.18.0-ee.jar`
* `flowave-cmmn-model-7.18.0-ee.jar`
* `flowave-dmn-model-7.18.0-ee.jar`
* `flowave-xml-model-7.18.0-ee.jar`
* `flowave-engine-dmn-7.18.0-ee.jar`
* `flowave-engine-feel-api-7.18.0-ee.jar`
* `flowave-engine-feel-juel-7.18.0-ee.jar`
* `flowave-engine-feel-scala-7.18.0-ee.jar`
* `flowave-commons-logging-$COMMONS_VERSION.jar`
* `flowave-commons-typed-values-7.18.0-ee.jar`
...
Install the Flowave EAR, or the file `$WAS_DISTRIBUTION/modules/flowave-ibm-websphere-ear-7.19.0-ee.ear`.
...
* On WebSphere 9:
  1. Deploy the web application `$WAS_DISTRIBUTION/webapps/flowave-engine-rest-7.19.0-ee-was.war` to your IBM WebSphere instance.
  2. Associate the web application with the `Flowave` shared library.
* On WebSphere Liberty:
  1. Place the web application `$WAS_DISTRIBUTION/webapps/flowave-engine-rest-7.19.0-ee-was.war` in the Liberty `$YOUR_SERVER/apps/` directory.
...
* On WebSphere 9:
  1. Deploy the web application `$WAS_DISTRIBUTION/webapps/flowave-webapp-ee-was-7.19.0-ee.war` to your IBM WebSphere instance.
  2. Associate the web application with the `Flowave` shared library.
* On WebSphere Liberty:
  1. Place the web application `$WAS_DISTRIBUTION/webapps/flowave-webapp-ee-was-7.19.0-ee.war` in the Liberty `$YOUR_SERVER/apps/` directory.
...
[was-distribution]: https://artifacts.camunda.com/artifactory/camunda-bpm-ee/org/finos/flowave/bpm/websphere/camunda-bpm-websphere9/7.19.0-ee/
