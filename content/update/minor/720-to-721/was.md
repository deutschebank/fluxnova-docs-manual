...
Throughout the procedure, refer to the [update guide][update-guide]. If not already done, download the [Flowave.21 IBM WebSphere distribution][was-distribution].
...
Install the Flowave EAR, or the file `$WAS_DISTRIBUTION/server/apps/flowave-ibm-websphere-ear-7.21.0-ee.ear`.
...
1. Place the web application `$WAS_DISTRIBUTION/server/apps/flowave-engine-rest-7.21.0-ee-was.war` in the Liberty `$YOUR_SERVER/apps/` directory.
...
1. Place the web application `$WAS_DISTRIBUTION/server/apps/flowave-webapp-ee-was-7.21.0-ee.war` in the Liberty `$YOUR_SERVER/apps/` directory.
...
[was-distribution]: https://artifacts.camunda.com/artifactory/camunda-bpm-ee/org/finos/flowave/bpm/websphere/camunda-bpm-websphere/7.21.0-ee/
