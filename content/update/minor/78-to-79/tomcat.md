...
[Flowave.9 Tomcat distribution][tomcat-distribution].
...
The pre-built Flowave.9 distribution ships with Tomcat 9.0.5, whereas 7.8 comes with Tomcat 8.0.47. Flowave.9 is 
