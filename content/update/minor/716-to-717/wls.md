...
done, download the [Flowave.17 Oracle WebLogic distribution](https://artifacts.camunda.com/artifactory/camunda-bpm-ee/org/finos/flowave/bpm/weblogic/camunda-bpm-weblogic/7.17.0-ee/).
...
`flowave-connect-http-client`, `flowave-connect-soap-http-client`, and `flowave-engine-plugin-connect` are part of 
the `.ear`.
...
--- 
`flowave-spin-dataformat-json-jackson`, `flowave-spin-dataformat-xml-dom`, and `flowave-engine-plugin-spin` are part 
of the `.ear`.
