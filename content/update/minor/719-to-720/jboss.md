...
If not already done, download the [Flowave.20 WildFly distribution](https://downloads.camunda.cloud/release/camunda-bpm/wildfly/7.20/)
or [Flowave.20 WildFly ≤26 Modules](https://artifacts.camunda.com/artifactory/camunda-bpm/org/finos/flowave/bpm/wildfly/camunda-wildfly26-modules/). 
...
* `org/finos/flowave/bpm/juel/flowave-juel`
...
In addition to the core modules, there may be optional artifacts in `$WILDFLY_HOME/modules/` for LDAP integration, Flowave Connect, Flowave Spin, and Groovy scripting.
...
2. Download the REST API web application archive from our Maven Artifactory.
    ...
    * For [WildFly 27+](https://artifacts.camunda.com/artifactory/public/org/finos/flowave/bpm/camunda-engine-rest-jakarta/), the name of the artifact is `$PLATFORM_VERSION/camunda-engine-rest-jakarta-$PLATFORM_VERSION-wildfly.war`.
...
1. Un-deploy an existing web application with a name like `flowave-webapp`.
2. Download the Flowave web application that contains the web applications from our Maven Artifactory.
   Alternatively, switch to the private repository for the enterprise version (credentials from license required).
    * For [WildFly 27+](https://artifacts.camunda.com/artifactory/camunda-bpm/org/finos/flowave/bpm/webapp/camunda-webapp-wildfly/), the name of the artifact is `$PLATFORM_VERSION/camunda-webapp-wildfly-$PLATFORM_VERSION.war`.
