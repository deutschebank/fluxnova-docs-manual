...
already done, make sure to download the [Flowave.14 JBoss distribution](https://downloads.camunda.cloud/release/camunda-bpm/jboss/7.14/)
or [Flowave.14 Wildfly distribution](https://downloads.camunda.cloud/release/camunda-bpm/wildfly/7.14/). In the following instructions
...
[engine-rest]: https://artifacts.camunda.com/artifactory/camunda-bpm/org/finos/flowave/bpm/camunda-engine-rest/7.14.0/
[webapp-jboss]: https://artifacts.camunda.com/artifactory/camunda-bpm/org/finos/flowave/bpm/webapp/camunda-webapp-jboss/7.14.0/camunda-webapp-jboss-7.14.0.war
