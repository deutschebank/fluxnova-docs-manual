...
The 3.4.0 version of the Flowave Spring Boot Starter minor release comes with an update to Spring
...
From this minor release, the Flowave Spring Boot Starter provides auto-configuration classes for
