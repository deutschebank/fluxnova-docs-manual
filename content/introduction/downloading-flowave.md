...
menu:
  main:
    identifier: "user-guide-introduction-downloading-flowave"
...
Before downloading Flowave, make sure you have a JRE (Java Runtime Environment), or better, a JDK
...
want to get to know Flowave quickly, without any additional setup or installation steps required.
...
{{< note title="Server/Container" class="info" >}}
  ...
  distribution, Tomcat itself is included and the Flowave binaries (process engine and
...
[community-download-page]: https://flowave.finos.org/download/
