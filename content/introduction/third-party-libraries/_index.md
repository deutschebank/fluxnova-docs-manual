...
This section covers third-party libraries and their use in Flowave. It provides the license book that lists the third-party dependencies that Flowave distributes along with its code.
...
You can find our rationale for using long-term support libraries in [our blog post on ensuring the long-term maintenance of Flowave](https://flowave.finos.org/blog/2022/02/ensuring-continuous-support-of-angularjs-in-flowave-platform-7-17/).

## Bootstrap NES and AngularJS NES by HeroDevs, Inc.
Starting with versions 7.20.9, 7.21.6, 7.22.1, and 7.23.0-alpha2 the Flowave web applications use a set of third-party libraries provided by HeroDevs, Inc.:
