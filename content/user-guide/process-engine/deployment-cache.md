...
One can do this by implementing the Cache interface from *org.finos.fluxnova.util.commons package*. Let's assume for example that the following class has been implemented:
...
<bean id="processEngineConfiguration" class="org.finos.fluxnova.bpm.engine.impl.cfg.StandaloneInMemProcessEngineConfiguration">
	...
	<property name="cacheFactory">
			<bean class="org.finos.fluxnova.bpm.engine.test.api.cfg.MyCacheFactory" />
	</property>
</bean>
```
