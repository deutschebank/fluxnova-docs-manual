...
They enable a quickstart for developing production-ready process applications using Flowave.
...
<table class="table table-bordered">
  ...
  <tbody>
    <tr>
      <td><a href="https://artifacts.camunda.com/artifactory/camunda-bpm/org/finos/flowave/bpm/archetype/camunda-archetype-cockpit-plugin/">Flowave Cockpit Plugin</a></td>
      <td>Plugin for Flowave Cockpit, contains REST-Backend, MyBatis database query, HTML and JavaScript frontend, Ant build script for one-click deployment</td>
    </tr>
    <tr>
      <td><a href="https://artifacts.camunda.com/artifactory/camunda-bpm/org/finos/flowave/bpm/archetype/camunda-archetype-ejb-war/">Process Application (EJB, WAR)</a></td>
      <td>Process application that uses a shared Flowave engine in a Java EE Container, e.g., Wildfly.
          Contains: Flowave EJB Client, Flowave CDI Integration, BPMN Process, Java Delegate as CDI bean, HTML5- & JSF-based start and task forms,
    ...
    <tr>
      <td><a href="https://artifacts.camunda.com/artifactory/camunda-bpm/org/finos/flowave/bpm/archetype/camunda-archetype-servlet-war/">Process Application (Servlet, WAR)</a></td>
      <td>Process application that uses a shared Flowave engine in a Servlet Container, e.g., Apache Tomcat.
    ...
    <tr>
      <td><a href="https://artifacts.camunda.com/artifactory/camunda-bpm/org/finos/flowave/bpm/archetype/camunda-archetype-spring-boot/">Flowave Spring Boot Application</a></td>
      <td>Application that uses the Flowave Spring Boot Starter.
          Contains: Spring Boot Process Application, Flowave Webapps, BPMN Process, Java Delegate, HTML5-based start and task forms,
          JUnit Test with in-memory engine, Maven Plugins for packing as an executable application.</td>
    </tr>
    <tr>
      <td><a href="https://artifacts.camunda.com/artifactory/camunda-bpm/org/finos/flowave/bpm/archetype/camunda-archetype-spring-boot-demo/">Flowave Spring Boot Application with Demo Users</a></td>
      <td>Same as the <i>Spring Boot Application</i> archetype and additionally creates demo users and groups for easy start with the Flowave Webapps (use <code>demo/demo</code> to log in).</td>
    </tr>
    <tr>
      <td><a href="https://artifacts.camunda.com/artifactory/camunda-bpm/org/finos/flowave/bpm/archetype/camunda-archetype-engine-plugin/">Process Engine Plugin</a></td>
...
We provide a template repository for every Flowave Archetype. 
Every repository contains a project generated from one specific template.
You can find the whole list on [GitHub](https://github.com/flowave?q=%22flowave-bpm-archetype-%22).

With every new release of the Archetypes, we will update those repositories with a new version as well.
This allows to investigate possible update paths from one Flowave version to another and also enables you to simply update your existing project by pulling in the latest changes.
...
4. Specify Maven coordinates and Flowave version and finish the project creation.
{{< img src="../img/eclipse-05-specify-maven-coordinates-and-flowave-version.png" title="Eclipse: Specify Maven coordinates and Flowave version" >}}
...
9. In the new project dialog, click on the left side on "Maven", check "Create from archetype" 
   and select any `org.finos.flowave.bpm.archetype` entry.
...
<pre class="console">
mvn archetype:generate -Dfilter=org.finos.flowave.bpm.archetype:
</pre>
...
mvn archetype:generate \
  ...
  -DarchetypeGroupId=org.finos.flowave.bpm.archetype \
  -DarchetypeArtifactId=flowave-archetype-ejb-war \
  -DarchetypeVersion=7.10.0 \
  -DgroupId=org.example.flowave.bpm \
  -DartifactId=flowave-bpm-ejb-project \
  -Dversion=0.0.1-SNAPSHOT \
  -Dpackage=org.example.flowave.bpm.ejb
</pre>


# Source Code and Customization

You can also customize the project templates for your own technology stack. Just [fork them on GitHub](https://github.com/finos/flowave-archetypes)!
