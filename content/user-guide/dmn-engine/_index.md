...
The Flowave DMN engine is a Java library which can evaluate DMN decision tables.
...
application or in combination with Flowave. This section
covers how to embed the library and use it to evaluate decisions. For more
information on the integration in Flowave, please see the
...
[GitHub]: https://github.com/finos/flowave-bpm-examples/tree/master/dmn-engine/dmn-engine-java-main-method
