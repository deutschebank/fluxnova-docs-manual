...
menu:
  main:
    ...
    pre: "Only relevant for users coming from Flowave version <= 7.12.0"

---

If you come from a Flowave version <= 7.12.x and already use FEEL, it might be that you need to 
...
* To see how this legacy behavior can be enabled again in Flowave, please see the
...
By using the legacy FEEL Engine, the Flowave DMN Engine **only** supports `FEEL` for 
...
[fluent feel flag setter]: {{< javadocref_url page="org/finos/flowave/bpm/dmn/engine/impl/DefaultDmnEngineConfiguration.html#enableFeelLegacyBehavior" >}}
[feel flag setter]: {{< javadocref_url page="org/finos/flowave/bpm/dmn/engine/impl/DefaultDmnEngineConfiguration.html#setEnableFeelLegacyBehavior" >}}
